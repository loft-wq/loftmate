...
// World country codes with flags
var countryCodes = [
    '🇦🇩', '🇦🇪', '🇦🇫', '🇦🇬', '🇦🇮', '🇦🇱', '🇦🇲', '🇦🇴', '🇦🇶', '🇦🇷', '🇦🇸', '🇦🇹', '🇦🇺', '🇦🇼', '🇦🇽', '🇦🇿',
    '🇧🇦', '🇧🇧', '🇧🇩', '🇧🇪', '🇧🇫', '🇧🇬', '🇧🇭', '🇧🇮', '🇧🇯', '🇧🇱', '🇧🇲', '🇧🇳', '🇧🇴', '🇧🇶', '🇧🇷', '🇧🇸', '🇧🇹', '🇧🇻', '🇧🇼', '🇧🇾', '🇧🇿',
    '🇨🇦', '🇨🇨', '🇨🇩', '🇨🇫', '🇨🇬', '🇨🇭', '🇨🇮', '🇨🇰', '🇨🇱', '🇨🇲', '🇨🇳', '🇨🇴', '🇨🇷', '🇨🇺', '🇨🇻', '🇨🇼', '🇨🇽', '🇨🇾', '🇨🇿',
...
function showInstallPromotion() {
    ...
    if (!document.getElementById('installButton')) {
        ...
        installButton.className = 'btn btn-success btn-small';
...
function displayPigeons() {
    ...
    var pigeonsByYear = {};
    pigeonsToShow.forEach(function(pigeon) {
    ...
    years.forEach(function(year) {
        ...
        yearPigeons.forEach(function(pigeon) {
            ...
            if (pigeonRaces.length > 0) {
                html += '<div class="detail-row"><span class="detail-label">Race Results:</span><span class="detail-value">' + pigeonRaces.length + ' result' + (pigeonRaces.length > 1 ? 's' : '') + '</span></div>';
            }
...
function createPigeonBox(pigeon, className, defaultTitle) {
    ...
    if (className === 'main') {
        var pigeonRaces = raceResults.filter(function(r) { return r.pigeonId === pigeon.id; });
        if (pigeonRaces.length > 0) {
            html += 'Race Results: ' + pigeonRaces.length + '<br>';
...
function generateConnectionLines() {
    ...
    // Main to parents
    lines += '<div class="connection-line h-line" style="left: 220px; top: 280px; width: 60px;"></div>';
    lines += '<div class="connection-line v-line" style="left: 280px; top: 210px; height: 140px;"></div>';
    lines += '<div class="connection-line h-line" style="left: 280px; top: 210px; width: 40px;"></div>';
    lines += '<div class="connection-line h-line" style="left: 280px; top: 350px; width: 40px;"></div>';
    
    // Parents to grandparents
    // Sire to his parents
    lines += '<div class="connection-line h-line" style="left: 440px; top: 210px; width: 40px;"></div>';
    lines += '<div class="connection-line v-line" style="left: 480px; top: 140px; height: 140px;"></div>';
    lines += '<div class="connection-line h-line" style="left: 480px; top: 140px; width: 40px;"></div>';
    lines += '<div class="connection-line h-line" style="left: 480px; top: 240px; width: 40px;"></div>';
    
    // Dam to her parents  
    lines += '<div class="connection-line h-line" style="left: 440px; top: 350px; width: 40px;"></div>';
    lines += '<div class="connection-line v-line" style="left: 480px; top: 340px; height: 80px;"></div>';
    lines += '<div class="connection-line h-line" style="left: 480px; top: 340px; width: 40px;"></div>';
    lines += '<div class="connection-line h-line" style="left: 480px; top: 440px; width: 40px;"></div>';
    
    // Grandparents to great grandparents
    // Sire's sire to his parents
    lines += '<div class="connection-line h-line" style="left: 640px; top: 140px; width: 40px;"></div>';
    lines += '<div class="connection-line v-line" style="left: 680px; top: 90px; height: 100px;"></div>';
    lines += '<div class="connection-line h-line" style="left: 680px; top: 90px; width: 40px;"></div>';
    lines += '<div class="connection-line h-line" style="left: 680px; top: 170px; width: 40px;"></div>';
    
    // Sire's dam to her parents
    lines += '<div class="connection-line h-line" style="left: 640px; top: 240px; width: 40px;"></div>';
    lines += '<div class="connection-line v-line" style="left: 680px; top: 220px; height: 60px;"></div>';
    lines += '<div class="connection-line h-line" style="left: 680px; top: 220px; width: 40px;"></div>';
    lines += '<div class="connection-line h-line" style="left: 680px; top: 270px; width: 40px;"></div>';
    
    // Dam's sire to his parents
    lines += '<div class="connection-line h-line" style="left: 640px; top: 340px; width: 40px;"></div>';
    lines += '<div class="connection-line v-line" style="left: 680px; top: 320px; height: 60px;"></div>';
    lines += '<div class="connection-line h-line" style="left: 680px; top: 320px; width: 40px;"></div>';
    lines += '<div class="connection-line h-line" style="left: 680px; top: 370px; width: 40px;"></div>';
    
    // Dam's dam to her parents
    lines += '<div class="connection-line h-line" style="left: 640px; top: 440px; width: 40px;"></div>';
    lines += '<div class="connection-line v-line" style="left: 680px; top: 420px; height: 60px;"></div>';
    lines += '<div class="connection-line h-line" style="left: 680px; top: 420px; width: 40px;"></div>';
    lines += '<div class="connection-line h-line" style="left: 680px; top: 470px; width: 40px;"></div>';
...
function generatePDFSingle(selectedPigeon) {
    ...
    // Race results
    if (pigeonRaces.length > 0) {
        printContent += '<h3 style="color: #667eea; border-bottom: 2px solid #667eea; padding-bottom: 10px;">Race Results (' + pigeonRaces.length + ')</h3>';
        ...
        printContent += '<th style="border: 1px solid #ddd; padding: 10px; text-align: center;">Position</th>';
...
function printPedigreeTree() {
    ...
    printWindow.document.write('.tree-box.sire { left: 280px; top: 150px; background: #FFB6C1; }');
    printWindow.document.write('.tree-box.dam { left: 280px; top: 290px; background: #E6E6FA; }');
    printWindow.document.write('.tree-box.sire-sire { left: 480px; top: 80px; background: #F0E68C; }');
    printWindow.document.write('.tree-box.sire-dam { left: 480px; top: 180px; background: #98FB98; }');
    printWindow.document.write('.tree-box.dam-sire { left: 480px; top: 280px; background: #87CEEB; }');
    printWindow.document.write('.tree-box.dam-dam { left: 480px; top: 380px; background: #DDA0DD; }');
    printWindow.document.write('.tree-box.sire-sire-sire { left: 680px; top: 30px; background: #FFEFD5; }');
    printWindow.document.write('.tree-box.sire-sire-dam { left: 680px; top: 110px; background: #F5DEB3; }');
    printWindow.document.write('.tree-box.sire-dam-sire { left: 680px; top: 160px; background: #FFFACD; }');
    printWindow.document.write('.tree-box.sire-dam-dam { left: 680px; top: 210px; background: #E0FFFF; }');
    printWindow.document.write('.tree-box.dam-sire-sire { left: 680px; top: 260px; background: #F0FFFF; }');
    printWindow.document.write('.tree-box.dam-sire-dam { left: 680px; top: 310px; background: #F5F5DC; }');
    printWindow.document.write('.tree-box.dam-dam-sire { left: 680px; top: 360px; background: #FDF5E6; }');
    printWindow.document.write('.tree-box.dam-dam-dam { left: 680px; top: 410px; background: #FAFAD2; }');
